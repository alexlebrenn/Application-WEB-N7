Blog::Application.routes.draw do
  get "post/index"
	...
	get "/posts/people/login", 									:controller => :people, :action => :login,		:as => :login_person
	post "/posts/people/login", 								:controller => :people, :action => :login
	get "/posts/people/logout",									:controller => :people, :action => :logout,		:as => :logout_person
	get "/posts/person/new",										:controller => :people, :action => :new, 			:as => :new_person
	get "/posts/person/:id",	 									:controller => :people, :action => :show, 		:as => :show_person
	post "/posts/person", 											:controller => :people, :action => :create,		:as => :create_person
	delete "/posts/person/:id",								 	:controller => :people, :action => :delete, 	:as => :delete_person
	get "/posts/person/:id/edit",								:controller => :people, :action => :edit, 		:as => :edit_person
	put "/posts/person/:id", 										:controller => :people, :action => :update, 	:as => :update_person
